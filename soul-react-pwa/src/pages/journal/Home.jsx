...
const JournalHome = () => {
  ...
  return (
    <div className="min-h-screen journal-home px-5 py-10">
      <JournalTop />
      <p className="font-poppins font-semibold text-[#3F356E] text-2xl text-center pt-5 pb-5">
        My Journal
      </p>
      <button
        className="w-full text-[#3F356E] font-poppins font-semibold text-[17px] py-5 rounded-[12px] 
      ...
      {journals.map((journal) => (
        <div
          key={journal.id}
          className="w-full bg-white rounded-[12px] py-5 px-5 mt-5 space-y-3 border border-[rgba(161,142,255,0.5)]"
          onClick={() => navigate(`/journal/edit/${journal.id}`)}
        >
          <p className="font-poppins text-[13px] text-[rgba(63,53,110,0.7)] font-light mb-[5px]">
          ...
          <p className="font-poppins text-[17px] text-[#3F356E] font-semibold mb-[5px]">
            {journal.title}
          </p>
          <p className="line-clamp-1 font-poppins text-[15.5px] text-[#3F356E] font-normal">
            {journal.entry}
          </p>
        </div>
      ))}
