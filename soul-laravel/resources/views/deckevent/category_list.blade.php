...
<div class="row ps-5 pe-5" id="cancel-row">
    <div class="col-xl-12 col-lg-12 col-sm-12 layout-top-spacing layout-spacing">
        ...
        <h5 class="pt-2 pb-2">Categories for Event</h5>
            ...
            <table id="deck-category-list" class="table dt-table-hover" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($category->level === 'Paid')
                            <span class="badge badge-light-success inv-status">{{ $category->level }}</span>
                            @else
                        ...
                        <td>
                            <a class="badge badge-light-primary text-start me-2 action-edit"
                                href="javascript:openEditModal({{ $category }} )">
                            ...
                            <a class="badge badge-light-danger text-start action-delete"
                                href="javascript:openDeleteAlert({{ $category->id }});">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 row justify-center items-center">
                                    <div class="contact-name">
                                        <label style="margin-bottom: 4px; color: white">Category Name*</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="contact-name mt-3 col-md-6 mb-3">
                                            <label style="margin-bottom: 4px; color: white">Type*</label>
                                            <select name="category_type" class="form-select form-control-sm"
                                                id="category_type">
                                                <option value="" selected hidden>Choose Level</option>
                                                <option value="Single">Only 1 Card</option>
                                                <option value="Double">3-5 Card</option>
...
function openAddModal() {
    ...
    $('#category_form #category_type option:eq(0)').prop('selected', true)
...
function submitCategory() {
    ...
    if (!categoryName || !categoryLevel || !categoryType || (!categoryId && !
            isInfoImg)) {
        Swal.fire({
            icon: 'error',
