...
<div class="row invoice layout-top-spacing layout-spacing">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        ...
        <div class="doc-container">
            <h5 class="pt-2 pb-2">Edit Notification</h5>
            <form action="{{ route('update-notification') }}" method="post" id="update_form">
                @csrf
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="description" name="description"
                                                ...
                                                value="{{ $notification->description }}">{{ $notification->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <a href="{{ route('send-notification', ['id' => $notification->id]) }}"
