...
<div class="row invoice layout-top-spacing layout-spacing">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        ...
        <div class="doc-container">
            <h5 class="pt-2 pb-2">Edit Deck Card</h5>
            <form action="{{ route('update-card') }}" method="post" enctype="multipart/form-data" id="update_form">
                @csrf
                <input type="hidden" name="card_id" value="{{ $deckCard->id }}">
                <div class="row">
                    <div class="col-xl-3">
                            ...
                            <div class="invoice-action-currency">
                                <div class="form-group mb-0">
                                    ...
                                    <div class="invoice-logo imgUp">
                                        <div class="imagePreview" @if (!empty($deckCard->card_img))
                                            style="background-image:url({{asset('storage/deckcards/' . $deckCard->card_img)}})"
                                            @endif></div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="description" name="description"
                                                ...
                                                value="{{ $deckCard->description }}">{{ $deckCard->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select name="category" class="form-select form-control-sm" id="category"
                                                value="{{ $deckCard->category }}">
                                                <option value="" selected hidden>Choose Category</option>
                                                @foreach($decks as $deck)
                                                <option value="{{ $deck->id }}" @if ($deckCard->category_id ===
                                                    $deck->id)
                                                    selected @endif>{{ $deck->cname }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
