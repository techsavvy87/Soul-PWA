...
<div class="row invoice layout-top-spacing layout-spacing">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        ...
        <div class="doc-container">
            <h5 class="pt-2 pb-2">New Meditation</h5>
            <form action="{{ route('create-meditation') }}" method="post" enctype="multipart/form-data"
                id="create_form">
                @csrf
                <div class="row">
                    <div class="col-xl-3">
                        ...
                        <div class="invoice-content">
                            <div class="invoice-detail-body">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-4" id="type_box">
                                        <div class="form-group">
...
function save() {
    ...
    if ((/^audio/.test(mediaType) && type === 'Audio') || (/^video/.test(mediaType) && type === 'Video') || type ===
        ...
        Swal.fire({
            icon: 'warning',
            title: "Please don't close the browser while creating the meditation.",
            width: '420px',
            customClass: {
                icon: 'swal-alert-icon',
                title: 'swal-alert-title'
