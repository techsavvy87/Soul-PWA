...
<div class="row invoice layout-top-spacing layout-spacing">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="doc-container">
            <h5 class="pt-2 pb-2">About Sessions with Paul</h5>
            @include('layouts.alerts')
            <form action="{{ route('save-sessions') }}" method="post" enctype="multipart/form-data" id="save_form">
                @csrf
                <div class="row">
                    <div class="col-xl-3">
                            ...
                            <div class="invoice-action-currency">
                                <div class="form-group mb-0">
                                    ...
                                    <div class="invoice-logo imgUp">
                                        <div class="imagePreview" @if (!empty($sessionInfo['cover_img']))
                                            style="background-image:url({{asset('storage/sessions/' . $sessionInfo['cover_img'])}})"
                                            @endif></div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm" name="title"
                                                id="title" value="{{ $sessionInfo['title'] }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="description" name="description"
                                                ...
                                                value="{{ $sessionInfo['description'] }}">{{ $sessionInfo['description'] }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex flex-row-reverse">
                                    <div>
                                        <a href="{{ route('fetch-sessions') }}"
