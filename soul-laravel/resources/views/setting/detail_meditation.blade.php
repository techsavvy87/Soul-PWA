...
@section('title', 'CreativeLab.TV Setting')
...
<div class="row invoice layout-top-spacing layout-spacing">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="doc-container">
            <h5 class="pt-2 pb-2">Meditation Information</h5>
            @include('layouts.alerts')
            <form action="{{ route('save-meditation') }}" method="post" id="save_form">
                @csrf
                <div class="row">
                    <div class="col-xl-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm" name="title"
                                                id="title" value="{{ $meditationData['title'] }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="description" name="description"
                                                ...
                                                value="{{ $meditationData['description'] }}">{{ $meditationData['description'] }}</textarea>
                                        </div>
                                    </div>
                                </div>
